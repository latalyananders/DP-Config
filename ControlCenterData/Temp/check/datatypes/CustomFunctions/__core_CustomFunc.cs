...
public static partial class CustomFunc
{
    private static readonly ILogger Logger = ServiceLocator.Instance.GetService<ILogService>().GetLogger("CustomFunc", LoggingFeature.Custom);
}
